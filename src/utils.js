...
Utils.prototype.differenceBetweenDates = function(date1,date2) {
  var diff    = Math.abs(date1 - date2);
  var minutes = Math.floor((diff/1000)/60);
  return minutes;
};  

Utils.prototype.differenceRelativeBetweenDates = function(date1,date2) {
  var diff    = date1 - date2;
  var minutes = Math.floor((diff/1000)/60);
  return minutes;
};

Utils.prototype.calculateOverlapingEvent = function(a_start, a_end, b_start, b_end) {
  var n_start  = null;
  var n_end    = null;
  var newEvent = false;
...
Utils.prototype.dateAdd = function(date, interval, units) {
